    ...
    public function getPrice($propertyId, $checkIn, $checkOut, $guestCount, $startTime, $endTime, $force = false)
    {
        ...
        */
        ...
        foreach ($dates as $date) {
            ...
            $countDays++;
            $weekPrice += $property->property_price->$var_tipo*$horas;
        }
        ...
        foreach ($dates as $key => $value) {
            ...
            if (in_array($value, array_keys($differentPriceDatePrice))) {
                ...
                $allDate[$key]['price'] = moneyFormat($symbol, numberFormat(($property->property_price->$var_tipo*$horas), $decimals));
                $allDate[$key]['original_price'] = ($property->property_price->$var_tipo*$horas);
        ...
        $result['total_night_price'] = $weekPrice;
