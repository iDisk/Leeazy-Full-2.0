...
class BookingController extends Controller
{
    ...
    */
    public function requested(Request $request)
    {
        ...
        //dd($data['booking_details']->start_time);
        $data['price_list'] = json_decode($this->helper->getPrice($data['booking_details']->property_id, $data['booking_details']->start_date, $data['booking_details']->end_date, $data['booking_details']->guest,$data['booking_details']->start_time,$data['booking_details']->end_time, true));
        $data['symbol'] = $this->helper->getCurrentCurrencySymbol();
