            ...
            for ($i = 0; $i < 7; $i++) {
                ...
                if ( $dateGreaterThanToday && ($property_price->available($date)=='Not available') && ($property_price->type($date)=='calendar') && (($property_price->color($date))!=null)) {
                    $out .= '<div class="col-md-02">
                                <div class="calender_box date-package-modal"  style="background-color:'.$property_price->color($date).' !important " id="'.$date.'" data-day="'.$day.'" data-month="'.$month.'" data-year="'.$year.'" data-starttime="'.$property_price->starttime($date).'" data-endtime="'.$property_price->endtime($date).'" data-price="'.$property_price->original_price($date).'" data-price_day="'.$property_price->original_price_day($date).'" data-price_week="'.$property_price->original_price_week($date).'" data-price_month="'.$property_price->original_price_month($date).'" data-status="'.$property_price->available($date).'"data-minday="'.$property_price->min_day($date).'">
                    ...
                    if (! $dateGreaterThanToday) {
                        $class = 'dt-not-available';
                        $out .= '<div class="col-md-02">
                                    <div class="calender_box date-package-modal '.$class.'" id="'.$date.'" data-day="'.$day.'" data-month="'.$month.'" data-year="'.$year.'" data-starttime="'.$property_price->starttime($date).'" data-endtime="'.$property_price->endtime($date).'" data-price="'.$property_price->original_price($date).'" data-status="'.$property_price->available($date).'" data-minday="'.$property_price->min_day($date).'">
                                        <div class="wkText final_day">'.$finalDay.' '.$today.'</div>
                                        <div class="dTfont wkText">'.$property_price->currency->org_symbol.$property_price->original_price($date).'</div>
                                    </div>
                                </div>';
                ...
                elseif ($dateGreaterThanToday && ($property_price->available($date)=='Not available') && ($property_price->type($date)=='normal')) {
                    ...
                    $out .= '<div class="col-md-02">
                                    <div class="calender_box date-package-modal '.$class.'" id="'.$date.'" data-day="'.$day.'" data-month="'.$month.'" data-year="'.$year.'" data-starttime="'.$property_price->starttime($date).'" data-endtime="'.$property_price->endtime($date).'" data-price="'.$property_price->original_price($date).'" data-price_day="'.$property_price->original_price_day($date).'" data-price_week="'.$property_price->original_price_week($date).'" data-price_month="'.$property_price->original_price_month($date).'" data-status="'.$property_price->available($date).'" data-minday="'.$property_price->min_day($date).'">
                                        <div class="wkText final_day">'.$finalDay.' '.$today.'</div>
                                        <div class="dTfont wkText">'.$property_price->currency->org_symbol.$property_price->original_price($date).'</div>
                                    </div>
                                </div>';
    ...
    { 
        ...
        for ($i=$start_date; $i<=$end_date; $i+=86400) {
            ...
            $data = [ 'property_id' => $request->id,
                        ...
                        'price_day'   => ($request->price_day) ? $request->price_day : '0',
                        'price_week'   => ($request->price_week) ? $request->price_week : '0',
                        'price_month'   => ($request->price_month) ? $request->price_month : '0',
