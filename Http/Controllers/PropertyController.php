...
class PropertyController extends Controller
{
    ...
    public function create(Request $request)
    {
        if ($request->isMethod('post')) {
            ...
            if ($validator->fails()) {
                ...
                $property_address->submarket      = $request->submarket;
                $property_address->submarket_oter = $request->submarket_oter;
    ...
    public function querySubmarket(){

        $cities = StartingCities::where('name','=',request('city'))->first();
        $propertyAddress = PropertyAddress::where('id','=',request('address_id'))->first();
    
        if ($cities) {
            
            return response()->json(['data' => 'ok','propertyAddress'=>$propertyAddress,'submarkets'=>$cities->submarkets]);
        }else{
    ...
    public function listing(Request $request, CalendarController $calendar)
    {
        ...
        if ($step == 'basics') {
            if ($request->isMethod('post')) {
                ...
                $property->number_desks       = $request->number_desks;
                $property->size_desks         = $request->size_desks;
                $property->description_desks  = $request->description_desks;

                $property->number_chairs      = $request->number_chairs;
                $property->description_chairs = $request->description_chairs;
 

                $property->description_examination = $request->description_examination;
            ...
            if ($request->isMethod('post')) {
                ...
                if ($validator->fails()) {
                    ...
                    $property_price->price_day         = $request->price_day;
                    $property_price->price_week        = $request->price_week;
                    $property_price->price_month       = $request->price_month;
                    ...
                    $property_price->currency_code_day  = $request->currency_code_day;
                    $property_price->currency_code_week = $request->currency_code_week;
                    $property_price->currency_code_month = $request->currency_code_month;
    ...
    { 
        ...
        return $this->helper->getPrice($request->property_id, $request->checkin, $request->checkout, $request->guest_count, $request->startTime, $request->endTime);
    }
    ...
    public function single(Request $request)
    {
        ...
        $data['furniture_amenities'] = Amenities::furniture($id);
        $data['comunications_amenities'] = Amenities::comunications($id);
        $data['general_amenities'] = Amenities::general($id);
        $data['exam_amenities'] = Amenities::exam($id);
        ...
        $data['startTime']        = (isset($request->starttime) && $request->starttime != '') ? $request->starttime:'';
        $data['endTime']          = (isset($request->endtime) && $request->endtime != '') ? $request->endtime:'';
