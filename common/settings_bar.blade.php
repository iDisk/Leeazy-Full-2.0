<div class="box box-info box_info">
	<div class="panel-body">
		...
		<ul class="nav navbar-pills nav-tabs nav-stacked no-margin" role="tablist">
			...
			@if(Helpers::has_permission(Auth::guard('admin')->user()->id, 'starting_submarket_settings'))
				<li class="{{ (Route::current()->uri() == 'admin/settings/starting-submarket') || (Route::current()->uri() == 'admin/settings/add-starting_submarket') || (Route::current()->uri() == 'admin/settings/edit-starting-submarket/{id}') ? 'active' : ''  }}">
					<a href="{{ url('admin/settings/starting-submarket') }}" data-group="home_submarket">Starting Submarket Settings</a>
				</li>
			@endif
